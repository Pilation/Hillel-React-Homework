  ...
  return (
    <div className="js-ContactBook">
      <p className="project-description">
        Contact-Book &amp; Contact-Form adopds to API changes. <br />
        Dependence on API data, Book &amp; Form shows new fields and inputs.
        <br />
        In Book you can change contact (oSubmit in PUT's to API), delete contact
        (DELETE to API). <br />
